...
use crate::field::{
    impl_arith_assign, impl_sum_prod, Adds, ConstInt, Muls, RandElement, Ring, Subs,
};
...
impl_arith_assign!(RR2_128, Add, add, AddAssign, add_assign);
impl_arith_assign!(RR2_128, Sub, sub, SubAssign, sub_assign);
impl_arith_assign!(RR2_128, Mul, mul, MulAssign, mul_assign);
impl_sum_prod!(RR2_128);

impl Adds for RR2_128 {}

impl Subs for RR2_128 {}

impl Muls for RR2_128 {}
