...
use crate::field::{
    impl_arith_assign, impl_sum_prod, Adds, ConstInt, Field, Muls, RandElement, Ring, Subs,
};
use rand::Rng;
...
impl_arith_assign!(FF2_128, Add, add, AddAssign, add_assign);
impl_arith_assign!(FF2_128, Sub, sub, SubAssign, sub_assign);
impl_arith_assign!(FF2_128, Mul, mul, MulAssign, mul_assign);
impl_sum_prod!(FF2_128);

impl Adds for FF2_128 {}

impl Subs for FF2_128 {}

impl Muls for FF2_128 {}
